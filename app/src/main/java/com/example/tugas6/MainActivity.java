...
public class MainActivity extends AppCompatActivity {
    ...
    String s1[], s2[], s3[];
    int images[] = {R.drawable.index2, R.drawable.index3, R.drawable.index4};
    ...
    // tugas recycle view
        ...
        s1 = getResources().getStringArray(R.array.Sarung);
        s2 = getResources().getStringArray(R.array.star);
        s3 = getResources().getStringArray(R.array.harga);
        SarungAdapter appAdapter = new SarungAdapter(this, s1, s2, s3, images);
